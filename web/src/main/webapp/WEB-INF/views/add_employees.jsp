    ...
    <form:form name="employeeform" action="addemployee" method="POST" modelAttribute="employee">
        <table border="0" align="center">
            ...
            <tr>
                ...
                <td><form:select path="authinticationLevel" class="form-control" data-toggle="dropdown"
                                 style="width:220px;">
...
<td><input onclick="location.href = 'go_to_manager_direct';" type="button" class="btn btn-primary" name="home"
           style=" float: left" value="Back to Home"></td>
</body>
</html>
